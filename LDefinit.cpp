...
void updateLVal(LValStruct& LVal, int n1, int n2, const Param& pm, const PauliMatrix& pal, const double* fact, const double* HermiteMatx, const double* HermiteMaty)
{
	...
	LVal.L2 = I * kappa * I20x * I20y * pal.pal0 + (F2 * I11x * I10y + F3 * I10x * I11y - (F1 * zl0 + F2 * xl0 + F3 * yl0) * I10x * I10y) * pal.pal0 + alphaSOC1 * I10x * (2.0 * alphay4 * pm.kCosal * I11y + (F3 * pm.kCosal - F1 * pm.kSinal * pm.sinBeta) * I10y)  * pal.pal1 -
